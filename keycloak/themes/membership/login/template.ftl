    ...
    <main class="${properties.kcLoginMain!}">
      ...
      <div class="${properties.kcLoginMainHeader!}">
        ...
        <div id="kc-header-wrapper" class="${properties.kcHeaderWrapperClass!}">
          <h1 id="kc-realm-name">${kcSanitize(msg("loginTitleHtml",(realm.displayNameHtml!'')))?no_esc}</h1>
          <#if clientName?has_content>
            <p id="kc-client-name" data-kc-client="name">${kcSanitize(clientName)?no_esc}</p>
          </#if>
        </div>
</header>
