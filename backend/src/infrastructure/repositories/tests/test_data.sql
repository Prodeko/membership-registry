...
INSERT INTO Member (user_id, email, first_name, last_name, home_municipality) VALUES
('3e1ab0ea-c56a-457f-961f-13938954bb2b', 'marjakarhu@example.org', 'Taneli', 'Mäkinen', 'Espoo'),
('11880220-c535-4afe-87a2-c59e213f87f4', 'tiinarautio@example.org', 'Johanna', 'Kettunen', 'Espoo'),
('ffbf88de-758d-498c-b6b4-6968162f2086', 'marjaana89@example.net', 'Juha', 'Lindfors', 'Espoo'),
('9842528d-e376-42ed-9416-af820bb397b7', 'anderssonsaara@example.org', 'Markku', 'Andersson', 'Espoo'),
('e27ea8f8-76a3-4386-a09e-694c5581915e', 'johannahytonen@example.org', 'Riitta', 'Tolonen', 'Espoo'),
('c13689ec-e7ff-4045-b18e-c501d54262c0', 'lappalainenjohannes@example.com', 'Marjatta', 'Toivonen', 'Espoo'),
('281114a8-98f6-43ca-9cb7-7cf563dc4b96', 'olivia81@example.net', 'Ilmari', 'Suhonen', 'Espoo'),
('9707582e-c149-45a7-bae1-4b0f4de4b06f', 'joelsuominen@example.net', 'Antti', 'Nyberg', 'Espoo'),
('b20e5370-f0ae-4c8f-bdf0-5743b8f85c7a', 'karoliinaylonen@example.net', 'Karoliina', 'Karppinen', 'Espoo'),
('473d18ff-6fdc-468f-9fcf-66533da375da', 'eemilmakinen@example.org', 'Zanteri', 'Kurki', 'Espoo');
